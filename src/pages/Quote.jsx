    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6 sm:p-10">
      ...
      <div className="max-w-4xl mx-auto space-y-8 mt-10">
        ...
        <form
          ...
          className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 space-y-6"
        >
          ...
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-2 rounded-xl bg-indigo-600 text-white py-3 font-medium hover:bg-indigo-700 transition"
          >
